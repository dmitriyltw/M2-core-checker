 ...
 */
namespace Ltw\MagentoChecker\Model\Config;

/**
 * Class CronConfig
 * @package Ltw\MagentoChecker\Model\Config
 */
class CronConfig extends \Magento\Framework\App\Config\Value
{
     ...
     * Cron string path
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/ltw_filechecker/schedule/cron_expr';

    /**
     * Cron model path
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/ltw_filechecker/run/model';
